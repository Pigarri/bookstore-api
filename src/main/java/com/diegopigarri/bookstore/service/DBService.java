...
public class DBService {
	...
	public void instanciaBaseDeDados() {
		...
		Categoria cat3 = new Categoria(null, "Biografias", "livros Biografias");
		
		Livro l1 = new Livro(null, "Clean code", "Robert Martin", "Lorem ipsum", cat1);
		Livro l2 = new Livro(null, "Engenraria de software", "Pigarri", "Lorem ipsum", cat1);
		Livro l3 = new Livro(null, "The Time Machine", "H.G Wells", "Lorem ipsum", cat2);
		Livro l4 = new Livro(null, "Words", "Pigarri", "Lorem ipsum", cat2);
		Livro l5 = new Livro(null, "Monge Executivo", "Roberta Miranda", "Lorem ipsum", cat2);
